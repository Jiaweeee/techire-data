...
export function AboutPage() {
    ...
    return (
        <>
            <Head 
                title="About"
                description="Learn how RealTechJobs helps tech professionals find fresh job opportunities directly from company career pages, without third-party recruiters."
